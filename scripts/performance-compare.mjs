...
const paths = { baseline: resolve('verification/local/baseline-0.5.0/core.mjs'), candidate: resolve('dist/core.mjs') };
...
try {
  for (const spec of cases) {
    ...
    writeFileSync('verification/local/performance-paired.json',JSON.stringify(evidence,null,2)+'\n');
  }
