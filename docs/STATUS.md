...
2026-09-17：迁移前后比较核心、CLI、浏览器和独立模型对照已实现；49 个双目标核心测试、16 组 CLI 和归档消费工程通过。公开 CI、mooncakes 指定安装和同版本网页仍待本轮发布复验，不将开发候选视为已发布。

# 当前交付状态

当前正式版本为 **0.3.0**，新增批量预检、MoonBit API 和 CI 接入示例，已完成发布与公开复验。[本轮证据](../verification/2026-09-16-v0.3.0/README.md)。
