import { compare_exports } from '../../dist/core.mjs';
...
self.onmessage = async ({ data }) => {
  try {
    ...
    const envelope = JSON.parse(compare_exports(before.encoded, after.encoded, before.sha, after.sha, data.compat, data.legacySpaces, 'json'));
